...
Here, the the random forest learners is around 0.15 worse in AUC when using Spatial Cross-Validation (SpCV) compared to Non-Spatial Cross-Validation (NSpCV).
