...
```{r lsl, echo=FALSE, fig.cap="Landslide initiation points (red) and non-landslide points (blue) in Southern Ecuador. Figure taken from @lovelace_geocomputation_2019.", fig.align="center", out.width="70%", dpi=75}
...
```{r ressp, fig.align='center', dpi=75, fig.cap="Example for five spatially disjoint partitions constructed with the `repeated_cv` resampling method."}
plot(resampling_sp, task = ecuador, crs = 4326)
```

### Non-spatial

```{r, fig.align='center', dpi=75}
