...
# A saved R object is used here to make the plotting work on any OS for this article.
# Usually macOS is not supported by the CLUTO algorithm.
# resampling$instantiate(task_st, "Date")
resampling = readRDS(system.file("spt-plotting-data.rda", package = "mlr3spatiotempcv"))
