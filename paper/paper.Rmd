...
To achieve this, observations need to be omitted as the split in test and train sets only provides one dimension to separate observations whereas two (space and time) are needed.
...
To achieve an effect for both, observations need to be omitted as shown in Fig. \@ref(fig:llto).
