...
#### Square and rectangular blocks --- blockCV
...
This procedure supports both random and systematic resampling of square blocks (argument `selection = "random"` and `"systematic"`, respectively).
...
Note that the actual number of folds obtained may be smaller than `nsplit[1]*nsplit[2]` (or smaller than what would be expected base don `dsplit`) since some blocks may be empty or (optionally) merged into adjacent folds. 
