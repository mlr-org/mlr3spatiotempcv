...
However, instead of using these options, the user might also supply a numeric value in meters via argument `theRange` (named just `range` in {mlr3spatiotempcv}) which will create a quadratic block pattern across the study area.
<!--JM: to stay consistent please add the argument which lets the user indicate a user-defined polygon-->
