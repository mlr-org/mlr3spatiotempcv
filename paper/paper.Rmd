...
<!--- They play an important role for an unbiased application of ML algorithms [@schratz2019]. [FIXME: Point gas been made before, it is unrelated to this section's topic.] -->
...
If no projection is specified, World Geodetic System 1984 (WGS84, EPSG: 4326) is assumed. <!--- FIXME: Is this correct even for distance metrics? Wouldn't it be more natural to simply use Euclidean distance when no projection is specified? In many cases coordinates will be UTM, not lat/lon... Just wondering. -->
