...
It is recommended (required) that one familiarizes themselves with multiple methods and decide which method to choose based on the specific characteristics of the dataset at hand and the prediction purpose of the fitted model, i.e. for which areas/zones a model should make predictions for.
...
- Are existing predictor variables known to be highly affected by spatiotemporal autocorrelation by nature?
