...
abstract: >
  ...
  This contribution reviews the state-of-the-art in spatial and spatiotemporal CV, and introduces the R package mlr3spatiotempcv as an extension package of the machine-learning framework **mlr3**.
  ...
  The goal of **mlr3spatiotempcv** is to gather the available spatiotemporal resampling methods in R and make them available to users through a simple and common interface.
...
`autoplot()` is \pkg{ggplot2}-based and uses [ggplot2](https://ggplot2.tidyverse.org) [@ggplot2] in two-dimensional geographic space and [plotly](https://github.com/ropensci/plotly) [@plotly] in the three dimensional case, i.e., geographic space plus time.
