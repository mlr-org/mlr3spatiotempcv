...
### Feature space clustering (blockCV)
...
```{r env-1, fig.cap="Environmental blocking using a single predictor.", cache=F, out.width="50%", fig.pos="ht"}
...
```{r env-2, fig.cap="Environmental blocking using multiple predictors.", cache=T, out.width="50%", fig.pos="ht"}
