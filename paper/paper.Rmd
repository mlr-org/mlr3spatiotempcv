...
<!--- FIXME: It sounds like CLUTO can potentially be applied to spatial coordinates, space-time coordinates, or a combinations of coordinates and features. Does mlr3spatiotempcv support this, or is it limited to coordinates? If yes, perhaps this would be worth mentioning: "CLUTO can be used to partition data based on spatial coordinates, space--time coordinates, features, or a combination of these." -->
