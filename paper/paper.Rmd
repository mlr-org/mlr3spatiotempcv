...
The following sections, which follow the naming scheme `<method name> --- <R package>`, give an overview of most existing partitioning strategies and their visualization.
...
<!-- FIXME: explain that most methdso can also be spatial-only -->
...
<!-- FIXME: mention missing spatiotemporal buffering method -->

<!-- missing: non-LOO method with buffer support -->
<!-- FIXME: this is wrong, leave-one-disc-out does this -->
