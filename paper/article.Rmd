...
```{r knndm-eval, fig.cap='Leave-one-block-out CV based on $k$-means clustering of the coordinates as implemented in package \\pkg{sperrorest} (method `"spcv\\_coords"` in \\pkg{mlr3spatiotempcv}).', out.width="60%", fig.pos="ht", echo=FALSE}
rsmp_coords = rsmp("spcv_coords", folds = 5)
