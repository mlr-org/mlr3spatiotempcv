...
```{r spcv_coords-all-partitions, warning=FALSE}
library(mlr3)
...
(See vignette ["Spatiotemporal Visualization"](https://mlr3spatiotempcv.mlr-org.com/articles/spatiotemp-viz.html) for an interactive 3D HTML variant.)

```{r spatiotemp, eval=FALSE}
library(plotly)
